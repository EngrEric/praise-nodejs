...
exports.sendVerifictionEmail = async (name, email, _id) => {
  try {
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "nwankwoben5@gmail.com", // generated ethereal user
        pass: "bnibkjnhjibczmyr", // generated ethereal password
      },
    });

    // AUTH_EMAIL=nwankwoben5@gmail.com
    // AUTH_PASSWORD=bnibkjnhjibczmyr
